                    ...
                    <div class="card-body">
                        <div class="mt-2">
                            ...
                            <div class="mt-2">
                                ...
                                <a href="{{ url('admin/akademik/ujian/cetak_uts/'.$mhs['nim']) }}" class="btn btn-primary btn-sm m-4" style="float: right;"><i class="fa fa-download"></i> Download Kartu Ujian UTS</a>
                            ...
                            <div class="mt-4">
                                ...
                                <a href="{{ url('admin/akademik/ujian/cetak_uas/'.$mhs['nim']) }}" class="btn btn-info btn-sm m-4" style="float: right;"><i class="fa fa-download"></i> Download Kartu Ujian UAS</a>
                                <div class="mt-2"></div>
                                <table class="table" id="tablekrs">
                                    <thead>
                                        <td>No.</td>
