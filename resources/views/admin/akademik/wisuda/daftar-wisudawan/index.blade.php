                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function render(data, type, full, meta) {
                            ...
                            const links = [
                                full.kk ? `<a href="${fileBase}/kk/${full.kk}" target="_blank" class="btn btn-sm btn-outline-primary mb-1" title="Lihat KK"><i class="fa fa-id-card"></i></a>` : '',
                                full.ktp ? `<a href="${fileBase}/ktp/${full.ktp}" target="_blank" class="btn btn-sm btn-outline-primary mb-1" title="Lihat KTP"><i class="fa fa-address-card"></i></a>` : '',
                                full.akte ? `<a href="${fileBase}/akte/${full.akte}" target="_blank" class="btn btn-sm btn-outline-primary mb-1" title="Lihat Akte"><i class="fa fa-address-book-o"></i></a>` : '',
                                full.ijazah_depan ? `<a href="${fileBase}/ijazah_depan/${full.ijazah_depan}" target="_blank" class="btn btn-sm btn-outline-primary mb-1" title="Lihat Ijazah Depan"><i class="fa fa-file"></i></a>` : '',
                                full.ijazah_belakang ? `<a href="${fileBase}/ijazah_belakang/${full.ijazah_belakang}" target="_blank" class="btn btn-sm btn-outline-primary mb-1" title="Lihat Ijazah Belakang"><i class="fa fa-file"></i></a>` : ''
                            ].filter(Boolean).join(' ');
                            return links ? links : '-';
                        }
                    },
