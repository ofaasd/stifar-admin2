...
<body>
    ...
    <hr>
    <center><b>Rekap Pembayaran Bulan {{ $list_bulan[$bulan] }} {{ $tahun }} @if(empty($prodi))Semua Program Studi @else Program Studi {{ $nama_prodi }} @endif</b></center>
    <br>
    <table class="customers"  id="myTable" cellpadding="5">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ ($row['status'] == 1)?'Lunas':'Belum Lunas' }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
