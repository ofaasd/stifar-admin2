                                ...
                                <div class="modal-content">
                                    <form action="javascript:void(0)" id="formAdd">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                <label for="nama_rumpun" class="form-label">Nama Rumpun</label>
                                                <input type="text" name="nama_rumpun" id="nama_rumpun" class="form-control">
                                            </div>
                                            <div class="mb-3">
                                                <label for="status" class="form-label">Status Rumpun</label>
