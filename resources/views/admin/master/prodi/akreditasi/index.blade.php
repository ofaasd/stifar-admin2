...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active">akreditasi Prodi</li>
@endsection
                                            ...
                                            <form action="javascript:void(0)" id="formAdd">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="nilai" id="nilai" class="form-control" step=".01" placeholder="cth : 85.59">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="capaian" id="capaian" class="form-control" placeholder="Capaian">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="lembaga" class="form-label">Lembaga</label>
                                                        <input type="text" name="lembaga" id="lembaga" class="form-control" placeholder="Cth : BAN - PT">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="tahun" class="form-label">Tahun</label>
                                                        <input type="text" name="tahun" id="tahun" class="form-control" placeholder="Cth : 2024">
                                                    </div>
                                                    <div class="mb-3">
...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            const page = '/'.concat("admin/masterdata/prodi/akreditasi");
            ...
            const dt = $("#basic-1").DataTable({
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render:function render(data, type, full, meta){
                            if(full['file']){
                                return (`<a target='_blank' href="${baseUrl}/assets/file/akreditasi/${full['file']}" class='btn btn-primary btn-sm'>File</a>`);
                            }else{
                                return (`<span class="btn btn-danger">Tidak Ada File</span>`);
                            }
                        }
                    },
                    {
