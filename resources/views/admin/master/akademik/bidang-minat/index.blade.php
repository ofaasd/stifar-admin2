                                ...
                                <div class="modal-content">
                                    <form action="javascript:void(0)" id="formAdd">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3" id="field-program-studi">
                                                <label for="id_prodi" class="form-label">Program Studi</label>
                                                <select class="form-select" name="idProgramStudi" id="id_prodi">
...
@section('script')
    ...
    <script>
        $(function () {
            ...
            const title2 = "{{ $title2 }}";
            const page = '/'.concat("admin/masterdata/akademik/").concat(title);
            ...
            $('#formAdd').on('submit',function(e){
                ...
                $.ajax({
                    ...
                    success: function success(status) {
                        ...
                        text: ''.concat(title2, ' ').concat(status, ' Successfully.'),
                        customClass: {
