                                    ...
                                    <form action="javascript:void(0)" id="formAdd">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <select  name="id_universitas" id="id_universitas" class="form-control">
                                            ...
                                            <div class="mb-3">
                                                <label for="kode_fak" class="form-label">Kode Fakultas</label>
                                                <input type="text" name="kode_fak" id="kode_fak" class="form-control">
                                            </div>
                                            <div class="mb-3">
                                                <label for="nama_fak" class="form-label">Nama Fakultas</label>
                                                <input type="text" name="nama_fak" id="nama_fak" class="form-control">
                                            </div>
                                            <div class="mb-3">
                                                <label for="tgl_berdiri" class="form-label">Tanggal Berdiri</label>
                                                <input type="date" name="tgl_berdiri" id="tgl_berdiri" class="form-control">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <label for="status" class="form-label">Status Waktu / Sesi</label>
