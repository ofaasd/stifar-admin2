            ...
            <div class="card">
              <div class="card-body">
                  ...
                  <form id="form-berkas" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" value="{{$dosen->nidnDosen}}" name="nidn">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-2">
                                <div id="view-ktp">
                                    ...
                                    <p class="fs-4" style="display: {{ $dosen->ktp ? 'block' : 'none' }}">
                                        ...
                                        <a href="{{ (isset($dosen->ktp)) ? asset('assets/images/dosen/' . $dosen->ktp) : '' }}" target="_blank">
                            ...
                            <div class="mb-2">
                                <div class="view-kk">
                                    ...
                                    <p class="fs-4" style="display: {{ $dosen->kk ? 'block' : 'none' }}">
                                        <i class="fa fa-check-square-o text-success"></i> | 
                                        <a href="{{ (isset($dosen->kk)) ? asset('assets/images/dosen/' . $dosen->kk) : '' }}" target="_blank">
                                            <i class="fa fa-picture-o text-dark"></i>
                                        </a> | 
                            ...
                            <div class="mb-2">
                                <div class="view-ijazah-s1">
                                    ...
                                    <p class="fs-4" style="display: {{ $dosen->ijazah_s1 ? 'block' : 'none' }}">
                                        <i class="fa fa-check-square-o text-success"></i> | 
                                        <a href="{{ (isset($dosen->ijazah_s1)) ? asset('assets/images/dosen/' . $dosen->ijazah_s1) : '' }}" target="_blank">
                                            <i class="fa fa-picture-o text-dark"></i>
                                        </a> | 
                            ...
                            <div class="mb-2">
                                <div class="view-ijazah-s2">
                                    ...
                                    <p class="fs-4" style="display: {{ $dosen->ijazah_s2 ? 'block' : 'none' }}">
                                        <i class="fa fa-check-square-o text-success"></i> | 
                                        <a href="{{ (isset($dosen->ijazah_s2)) ? asset('assets/images/dosen/' . $dosen->ijazah_s2) : '' }}" target="_blank">
                                            <i class="fa fa-picture-o text-dark"></i>
                                        </a> | 
                            ...
                            <div class="mb-2">
                                <div class="view-ijazah-s3">
                                    ...
                                    <p class="fs-4" style="display: {{ $dosen->ijazah_s3 ? 'block' : 'none' }}">
                                        <i class="fa fa-check-square-o text-success"></i> | 
                                        <a href="{{ (isset($dosen->ijazah_s3)) ? asset('assets/images/dosen/' . $dosen->ijazah_s3) : '' }}" target="_blank">
                                            <i class="fa fa-picture-o text-dark"></i>
                                        </a> | 
                            ...
                            <div class="mb-2">
                                <div class="view-serdik-aa-pekerti">
                                    ...
                                    <p class="fs-4" style="display: {{ $dosen->serdik_aa_pekerti ? 'block' : 'none' }}">
                                        <i class="fa fa-check-square-o text-success"></i> | 
                                        <a href="{{ (isset($dosen->serdik_aa_pekerti)) ? asset('assets/images/dosen/' . $dosen->serdik_aa_pekerti) : '' }}" target="_blank">
                                            <i class="fa fa-picture-o text-dark"></i>
                                        </a> | 
                            ...
                            <div class="mb-2">
                                <div class="view-serdik-aa">
                                    ...
                                    <p class="fs-4" style="display: {{ $dosen->serdik_aa ? 'block' : 'none' }}">
                                        <i class="fa fa-check-square-o text-success"></i> | 
                                        <a href="{{ (isset($dosen->serdik_aa)) ? asset('assets/images/dosen/' . $dosen->serdik_aa) : '' }}" target="_blank">
                                            <i class="fa fa-picture-o text-dark"></i>
                                        </a> | 
                            ...
                            <div class="mb-2">
                                <div class="view-serdik-lektor">
                                    ...
                                    <p class="fs-4" style="display: {{ $dosen->serdik_lektor ? 'block' : 'none' }}">
                                        <i class="fa fa-check-square-o text-success"></i> | 
                                        <a href="{{ (isset($dosen->serdik_lektor)) ? asset('assets/images/dosen/' . $dosen->serdik_lektor) : '' }}" target="_blank">
                                            <i class="fa fa-picture-o text-dark"></i>
                                        </a> | 
                            ...
                            <div class="mb-2">
                                <div class="view-serdik-kepala-guru-besar">
                                    ...
                                    <p class="fs-4" style="display: {{ $dosen->serdik_kepala_guru_besar ? 'block' : 'none' }}">
                                        <i class="fa fa-check-square-o text-success"></i> | 
                                        <a href="{{ (isset($dosen->serdik_kepala_guru_besar)) ? asset('assets/images/dosen/' . $dosen->serdik_kepala_guru_besar) : '' }}" target="_blank">
                                            <i class="fa fa-picture-o text-dark"></i>
                                        </a> | 
