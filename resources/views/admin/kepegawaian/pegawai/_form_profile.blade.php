        ...
        {{-- <div class="row"> --}}
            {{-- <div class="col-md-6">
                <div class="mb-2"> --}}
                    ...
                    {{-- <div class="col-sm-12"> --}}
                        <input type="hidden" class="form-control" name="gelar_depan" value="{{$pegawai->gelar_depan}}" placeholder="Ex: Dr., Ir.,">
                    {{-- </div>
                </div>
            </div>
            <div class="col-md-6"> --}}
                {{-- <div class="mb-2"> --}}
                    ...
                    {{-- <div class="col-sm-12"> --}}
                        <input type="hidden" class="form-control" name="gelar_belakang" value="{{$pegawai->gelar_belakang}}" placeholder="Ex: S.ked, S.Farm, M.Farm">
                    {{-- </div> --}}
                {{-- </div> --}}
            {{-- </div> --}}
        {{-- </div> --}}
