        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="alert alert-primary inverse alert-dismissible fade show" role="alert"><i class="icon-help-alt"></i>
                    <p>Halaman ini digunakan untuk memverifikasi pembayaran awal yang dilakukan oleh mahasiswa baru </p>
                            ...
                            <table class="display" id="pengumuman-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{URL::to('admin/admisi/verifikasi_pembayaran/'. $row->id .'')}}" title="Lihat Pendaftar" class="btn btn-primary btn-xs add_nilai" data-id="{{$row['id']}}" ><i class="fa fa-eye"></i>Lihat Detail</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
