                            ...
                            <table class="display" id="pengumuman-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{URL::to('admin/admisi/generate_nim/'. $row->id .'')}}" title="Lihat Pendaftar" class="btn btn-primary btn-xs add_nilai" data-id="{{$row['id']}}" ><i class="fa fa-eye"></i>Lihat Detail</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
