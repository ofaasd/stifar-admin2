                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @foreach ($dataDosbim as $item)
                                <tr>
                                    <td>15 Oktober 2023</td>
                                    <td>
                                        <strong>Pembimbing 1:</strong> {{ $item->nama_pembimbing1 }}<br>
                                        <strong>Pembimbing 2:</strong> {{ $item->nama_pembimbing2 }}
                                    </td>
                                    <td>
                                        @if ($item->status == 0)
