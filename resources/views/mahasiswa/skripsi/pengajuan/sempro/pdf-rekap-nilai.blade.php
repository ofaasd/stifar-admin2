...
<head>
    <meta charset="UTF-8">
    <title>Lembar Rekap Nilai Seminar Proposal</title>
    <style>
...
<body>
    ...
    <div class="doc-title">LEMBAR REKAP NILAI SEMINAR PROPOSAL</div>
    ...
    <table class="recap-table">
        <thead>
            <tr>
                ...
                <th colspan="2" class="col-nilai">Nilai Seminar Proposal</th>
            </tr>
            <tr>
                <th class="col-nilai">Nilai (70%)</th>
        ...
        <tfoot>
            ...
            <tr class="footer-row">
                <td colspan="2">Apakah penelitian perlu diuji Ethical Clearance?</td>
                <td style="padding-right:20px;">Tidak</td>
                <td style="padding-right:20px;">Ya</td>
            </tr>
            <tr>
                <td colspan="2" style="vertical-align: top;">
                    <p class="text-bold">Keterangan Hasil Sidang</p>
                    (Jika nilai rata-rata adalah &ge; 70 mahasiswa dinyatakan DISETUJUI masuk ke tahap pengambilan data)
                </td>
                <td colspan="2" style="vertical-align: top;">
