    ...
    <div class="nav-right col-xxl-7 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
      <ul class="nav-menus">
        ...
        <li class="profile-nav onhover-dropdown pe-0 py-0">
          ...
          @endphp
          <div class="media profile-media"><img class="b-r-10" src="{{ (!empty($pegawai->foto))?asset('assets/images/pegawai/' . $pegawai->foto):asset('assets/images/dashboard/profile.png') }}" alt="">
