...
use App\Http\Controllers\admin\aset\CetakAsetController;
...
Route::post('/parent', [ParentController::class, 'show'])->name('parent.show');
...
Route::group(['middleware' => ['auth', 'role:super-admin|admin-prodi|baak|admin-pmb',]], function () {
    ...
    Route::post('/admin/keuangan/tagihan/update_publish', [TagihanController::class, 'update_publish']);
    ...
    Route::delete('/admin/keuangan/rekening_koran/arsip/{id}', [RekeningKoranArsipController::class, 'delete']);
    ...
    Route::get('/admin/keuangan/pembayaran/remove-duplicates/{bulan}/{tahun}', [PembayaranController::class, 'removeDuplicates']);
    Route::get('/admin/keuangan/statistik/update_total_tagihan', [StatistikKeuanganController::class, 'update_total_tagihan']);
    Route::get('/admin/keuangan/statistik/cetak/{id}/{gelombang}', [StatistikKeuanganController::class, 'cetak']);
    ...
    Route::resource('admin/aset/cetak', CetakAsetController::class)->name('index', 'aset-cetak');
    Route::post('/admin/aset/cetak/cetak', [CetakAsetController::class, 'generatePdf'])->name('aset-cetak');
...
Route::group(['middleware' => ['auth', 'role:mhs|super-admin|admin-prodi']], function () {
    ...
    Route::group(['prefix' => 'mahasiswa/skripsi/pengajuan/judul', 'as' => 'mhs.pengajuan.judul.', 'controller' => PengajuanSkripsiController::class], function () {
        Route::get('/', 'index')->name('index');
        Route::post('/cek-bidang-minat', 'cekBidangMinat')->name('cek-bidang-minat');
        Route::post('/store', 'store')->name('store');
    });
    ...
    Route::group(['prefix' => 'mahasiswa/skripsi/daftar', 'as' => 'mhs.skripsi.daftar.', 'controller' => PengajuanController::class], function () {
        ...
        Route::post('/print-formulir-pendaftaran-hasil', 'printPendaftaranSidangHasil')->name('print-formulir-pendaftaran-hasil');
        Route::post('/print-formulir-persetujuan-hasil', 'printPersetujuanSidangHasil')->name('print-formulir-persetujuan-hasil');
        Route::post('/print-tanda-terima-naskah', 'printTandaTerimaNaskah')->name('print-tanda-terima-naskah');
    });
...
Route::group(['middleware' => ['auth', 'role:pegawai-dosen|pegawai|admin-prodi|super-admin']], function () {
        ...
        Route::prefix('skripsi')->name('skripsi.')->group(function () {
            ...
            Route::prefix('dosen')->name('dosen.')->group(function () {
                ...
                Route::prefix('bimbingan')->name('bimbingan.')->group(function () {
                    ...
                    Route::put('/upload-revisi/{idEnkripsi}', [DosenBimbinganController::class, 'uploadRevisi'])->name('upload-revisi');
                });
    ...
    Route::post('dosen/validasi-krs-satuan', [DosenController::class, 'valiKrsSatuan'] );
    Route::post('dosen/validasi-krs', [DosenController::class, 'valiKrs'] );
    Route::post('dosen/izinkan-skripsi', [DosenController::class, 'izinkanSkripsi'] );
    Route::get('dosen/krm', [KrmController::class, 'index'] );
